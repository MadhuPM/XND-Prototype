...
const RealTimeMultiChart = () => {
  ...
  var chart = function(s) {
    ...
    y = d3.scalePoint().domain(yDomain).range([height, 0], 1);
    ...
    setInterval(function() {
      ...
      //console.log('d3.brushSelection(viewport)', d3.brushSelection(viewport))
      var extent = d3.brushSelection(viewport) === null ? xNav.domain() : viewport.extent();
  ...
  chart.yDomain = function(_) {
    ...
    if (svg) {
      ...
      y = d3.scaleOrdinal().domain(yDomain).rangeRoundPoints([height, 0], 1);
      // update the y axis
      yAxis.scale(y)(yAxisG);
...
export default RealTimeMultiChart;